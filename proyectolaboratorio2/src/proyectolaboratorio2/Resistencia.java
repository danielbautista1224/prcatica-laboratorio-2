...
public class Resistencia extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Franja 4");

        jLabel2.setText("Franja 3");

        jLabel3.setText("Franja 2");

        jLabel4.setText("Franja 1");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(46, 46, 46)
                        .addComponent(valor_resistencia, javax.swing.GroupLayout.PREFERRED_SIZE, 299, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void calculaloActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_calculaloActionPerformed
        ...
        if (franja4.getSelectedItem()=="Oro")
        {
            valor4=5.0;
        }
        if (franja4.getSelectedItem()=="Plata")
        {
            valor4=10.0;           
        }
